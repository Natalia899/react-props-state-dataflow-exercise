...
class App extends Component {
  ...
  //     instances.push(<Company name={companies[i].name} revenue={companies[i].revenue} />)
  //   }
  //   return instances
  // }
      ...
      <div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-2">
            {companies.map(c => <Company name={c.name} key={c.name} revenue={c.revenue} />)}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-3">
            {companies.map(c => <Company name={this.upperCase(c.name)} key={c.name} revenue={c.revenue} />)}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-6">
            {this.state.companies.map(c => <div key={c.name}>{c.name} {c.revenue}</div>)}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="ex-3">
            {this.state.currentPage === "Landing" ? <Landing store={this.state.store} user={this.state.user} /> : <Home store={this.state.store} />}
          </div>
        </div>
